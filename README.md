...
- **Pass** — a button under every review card parks a word for two months without grading it. Built for the recognize tier, where reading it once is the whole job.
