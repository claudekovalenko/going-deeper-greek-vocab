...
- **Hear the word** — a speaker button in the corner of every card (and on Greek quiz prompts) pronounces the Greek using the device's own voices, so it works offline. Only the headword is spoken, not the parsing info.
