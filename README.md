...
- **Pass** — recognize-tier cards carry a small Pass chip in the header, opposite the counter and far from the grading row, so it cannot be hit by accident. It parks the word for two months without recording a grade. Memorize cards never show it.
