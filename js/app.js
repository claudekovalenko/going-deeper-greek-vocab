...
function openWordEditor(w) {
  ...
  view.innerHTML = `
    ...
    <div class="card-panel">
      <h2>Memory hint</h2>
      <p class="muted">A picture or a phrase that helps the word stick. It stays hidden while you study until you tap \u201cShow hint\u201d.</p>
      ...
      <input type="text" id="note" placeholder="Note or mnemonic (optional)" value="${esc(h.note || "")}">
